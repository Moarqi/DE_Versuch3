...
\section*{Auswertung}
Wie sich an \autoref{graphAusgangskennlinie} erkennen lässt, liegt die Schwellspannung des Transistors bei $U_{GS} = 1.8V$. Im Bereich zwischen $1.8V$ und $3.2V$ lässt sich der Triodenbereich erkennen, in welchem wir einen exponentiellen Anstieg der Leitfähigkeit feststellen können. Ab $3.2V$ befindet sich die Diode dann im Sättigungsbereich. Der Arbeitspunkt liegt im Schnitt der Kennlinie und der Arbeitsgeraden, also an der Stelle auf der Kennlinie, welche mit dem anhängenden Verbraucher übereinstimmt. Daraus lässt sich ablesen, welche Spannung nötig ist, um diesen Verbraucher zu versorgen.
